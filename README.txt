...
Packer downloads the Ubuntu 26.04.1 Server ISO.
Ubuntu is installed automatically using Autoinstall.
Packer creates a Vagrant box file in the `builds` directory.
The box is added to Vagrant.
Vagrant creates and starts the VirtualBox VM.
Manual Packer build
